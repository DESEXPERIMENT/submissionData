...
if __name__ == "__main__":
	...
	while  1:
		...
		conn.request('GET', '/vehicle?lat=38.722185&lng=-9.139251&radius=400000','',headersDynamic)
		...
		if 'Content-Encoding' in response_headers.keys():
			...
			filenm = dpath +"Lisbon/Data-responseEncoded-"+nowf2.strftime("%Y-%m-%d")+".txt"
			...
			print(ietc,'Starters at:',nowf3.strftime('%I:%M %p'),': Tier Lisbon')
			ietc +=1
			if(ietc > 100):
				ietc = 0
				print('longer sleep')
