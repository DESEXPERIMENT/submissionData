...
myCitiesList = [           'Lisbon',         'Lisbon',         'Lisbon', 'Lisbon', 'Lisbon']
...
myCityUrl = [
#DC
'/bird/nearby?latitude=38.7077522277832&longitude=-9.136590957641602&radius=100000.0', 
'/bird/nearby?latitude=38.720118&longitude=-9.117921&radius=100000.0',
'/bird/nearby?latitude=38.733158&longitude=-9.138916&radius=100000.0',
'/bird/nearby?latitude=38.726279&longitude=-9.151158&radius=100000.0',
'/bird/nearby?latitude=38.714694&longitude=-9.147560&radius=100000.0'
]
myCityLoc = [
#DC
'{"accuracy":1.3498684167861938,"altitude":57.0,"heading":null,"latitude":38.7077522277832,"longitude":-9.136590957641602,"mocked":true,"speed":0.0}', 
'{"accuracy":1.3924957513809204,"altitude":57.0,"heading":null,"latitude":38.720118,"longitude":-9.117921,"mocked":true,"speed":0.0}',
'{"accuracy":1.6441841125488281,"altitude":57.0,"heading":null,"latitude":38.733158,"longitude":-9.138916,"mocked":true,"speed":0.0}',
'{"accuracy":1.5051865577697754,"altitude":57.0,"heading":null,"latitude":38.726279,"longitude":-9.151158,"mocked":true,"speed":0.0}',
'{"accuracy":1.5797275304794312,"altitude":57.0,"heading":null,"latitude":38.714694,"longitude":-9.147560,"mocked":true,"speed":0.0}',
]
serverNumber = 0;
tid1= None
procs=[]
...
def mainProc():
	...
	while 1:
		...
		with Manager() as manager:
			...
			#print(reqContent)	
			print(ietNumber," ~~[Lisbon]~~ - Started at:",nowf.strftime('%I:%M %p'),"-In Time M:", int(((int(round(time.time() * 1000)) - current_milli_timeLife)/1000)/60),"-S:", int(((int(round(time.time() * 1000)) - current_milli_timeLife)/1000)%60))	
			ietNumber += 1
			mainCount += 1
