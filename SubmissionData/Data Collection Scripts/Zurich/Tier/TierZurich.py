...
if __name__ == "__main__":
	...
	while  1:
		...
		conn.request('GET', '/vehicle?lat=47.375837&lng=8.540028&radius=400000','',headersDynamic)
		...
		if 'Content-Encoding' in response_headers.keys():
			...
			filenm = dpath +"Zurich/Data-responseEncoded-"+nowf2.strftime("%Y-%m-%d")+".txt"
			...
			print(ietc,'Starters at:',nowf3.strftime('%I:%M %p'),': Tier Zurich')
			ietc +=1
			if(ietc > 100):
				ietc = 0
				print('longer sleep')
