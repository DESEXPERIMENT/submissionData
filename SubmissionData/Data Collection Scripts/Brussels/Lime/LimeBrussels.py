...
leftCol = [50.857897, 4.337842 ,50.817682, 4.320420]
rightCol = [50.854649, 4.368821,50.816501, 4.382137]
...
authCodes = ['Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX3Rva2VuIjoiVDJTTVc2R1BBNVJaUiIsImxvZ2luX2NvdW50IjoxfQ.fw0G0DNEWS5qPnvwz-Q5Af8bDiSYPl4_jdHePDyCNqk']
def fillHeaders(tid):
...
def mainProc():
	...
	while ik < 24:
		...
		with Manager() as manager:
			...
			#print(reqContent)	
			print(ietNumber,"- ~~[Brussels]~~ Started at:",nowf.strftime('%I:%M %p'),"-In Time M:", int(((int(round(time.time() * 1000)) - current_milli_timeLife)/1000)/60),"-S:", int(((int(round(time.time() * 1000)) - current_milli_timeLife)/1000)%60))	
			ietNumber += 1
			mainCount += 1
			time.sleep(2)
			ik += 3
