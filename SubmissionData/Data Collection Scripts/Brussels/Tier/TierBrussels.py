...
if __name__ == "__main__":
	...
	while  1:
		...
		conn.request('GET', '/vehicle?lat=50.847228&lng=4.352779&radius=400000','',headersDynamic)
		...
		filenm = dpath +"Brussels/Data-responseEncoded-"+nowf2.strftime("%Y-%m-%d")+".txt"
		...
		content = str(milis)+'--'+str(content_raw.decode())
		...
		print(ietc,'Starters at:',nowf3.strftime('%I:%M %p'),': Tier Brussels')
		ietc +=1
		if(ietc > 100):
			ietc = 0
			print('longer sleep')
