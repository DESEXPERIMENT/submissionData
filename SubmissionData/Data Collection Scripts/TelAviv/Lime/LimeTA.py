...
myCitiesList = [           'Brussels',         'Berlin',             'Chicago',                 'DC',               'Detroit',            'Lisbon',             'Paris',              'SanFrancisco' , 'Tel Aviv']
...
leftCol = [32.092377, 34.773149 , 32.074140, 34.764965]
rightCol = [32.087521, 34.794020, 32.064778, 34.781658]
...
authCodes = ['Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX3Rva2VuIjoiV0k3QlNWWDJTMlJGWCIsImxvZ2luX2NvdW50IjoxfQ.tmTQeehEEtIObddE4AGsnthWOgYiCUI9gL9py4yJNF4']
def fillHeaders(tid):
