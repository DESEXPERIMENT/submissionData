...
headersDynamic = {}
cityCoords = []
leftCol = [32.092341, 34.773189, 32.074100, 34.765103]
rightCol = [32.089814, 34.791997, 32.068979, 34.780418]
...
#		print(2*i,(2*i)+1)
	...
	print(ietc,'Starterd at:',nowf3.strftime('%I:%M %p'),': Wind Tel Aviv')
	ietc +=1
