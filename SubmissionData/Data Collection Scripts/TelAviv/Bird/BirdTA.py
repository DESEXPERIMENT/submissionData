...
myCityUrl = [
#DC
'/bird/nearby?latitude=32.080482482910156&longitude=34.7805290222168&radius=100000.0', 
'/bird/nearby?latitude=32.095000&longitude=34.773948&radius=100000.0',
'/bird/nearby?latitude=32.091596&longitude=34.798633&radius=100000.0',
'/bird/nearby?latitude=32.059233&longitude=34.783884&radius=100000.0',
'/bird/nearby?latitude=32.067955&longitude=34.763307&radius=100000.0'
]
myCityLoc = [
#DC l r r l
'{"accuracy":1.4679450988769531,"altitude":57.0,"heading":null,"latitude":32.080482482910156,"longitude":34.7805290222168,"mocked":true,"speed":0.0}',
'{"accuracy":1.3924957513809204,"altitude":57.0,"heading":null,"latitude":32.095000,"longitude":34.773948,"mocked":true,"speed":0.0}',
'{"accuracy":1.2365895509719849,"altitude":57.0,"heading":null,"latitude":32.091596,"longitude":34.798633,"mocked":false,"speed":0.0}', 
'{"accuracy":1.6441841125488281,"altitude":57.0,"heading":null,"latitude":32.059233,"longitude":34.783884,"mocked":true,"speed":0.0}',
'{"accuracy":1.5051865577697754,"altitude":57.0,"heading":null,"latitude":32.067955,"longitude":34.763307,"mocked":true,"speed":0.0}',
]
serverNumber = 0;
tid1= None
procs=[]
...
def readResponseUber(tid, response):
	...
	filenm = dpath +'TA'+"/P-"+str(tid)+"-responseEncoded-"+nowf2.strftime("%Y-%m-%d")+".txt"
...
def mainProc():
	...
	while 1:
		...
		with Manager() as manager:
			...
			#print(reqContent)	
			print(ietNumber," ~~[Tel Aviv]~~ - Started at:",nowf.strftime('%I:%M %p'),"-In Time M:", int(((int(round(time.time() * 1000)) - current_milli_timeLife)/1000)/60),"-S:", int(((int(round(time.time() * 1000)) - current_milli_timeLife)/1000)%60))	
			ietNumber += 1
			mainCount += 1
